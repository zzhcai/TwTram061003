...
def clean_text(text):
    return clean(text, fix_unicode=True, to_ascii=True, lower=True,
                 ...
                 no_currency_symbols=True, no_punct=True, replace_with_punct="",
                 replace_with_url="", replace_with_email="",
                 replace_with_phone_number="", replace_with_number="",
                 replace_with_digit="", replace_with_currency_symbol="",
                 lang="en").split(' ')
...
def sn_sentence(sentence):
    ...
    return {'word_num': valid_word_num, 
...
def aggregated_scores(lis):
    ...
    if word_num == 0:
        word_num += 1
    return {'polarity_score': polarity_score / word_num, 
